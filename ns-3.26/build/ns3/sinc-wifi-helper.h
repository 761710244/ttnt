...
#ifndef SINC_WIFI_HELPER_H
#define SINC_WIFI_HELPER_H
...
#include "ns3/sinc-wifi-phy-standard.h"
#include "ns3/trace-helper.h"
#include "ns3/sinc-wifi-mac-helper.h"
#include "ns3/sinc-wifi-phy.h"

namespace ns3 {class Node; namespace sincgars {
...
public:
   ...
   */
  virtual Ptr<WifiPhy> Create (Ptr<ns3::Node> node, Ptr<ns3::NetDevice> device) const = 0;
