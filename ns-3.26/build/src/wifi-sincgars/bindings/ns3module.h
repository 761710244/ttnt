...
#include "ns3/wifi-sincgars-module.h"
...
public:
    ...
    inline void PcapSniffRxEvent__parent_caller(ns3::Ptr< ns3::PcapFileWrapper > file, ns3::Ptr< ns3::Packet const > packet, uint16_t channelFreqMhz, uint16_t channelNumber, uint32_t rate, ns3::WifiPreamble preamble, ns3::WifiTxVector txVector, ns3::mpduInfo aMpdu, ns3::signalNoiseDbm signalNoise)
    { ns3::WifiPhyHelper::PcapSniffRxEvent(file, packet, channelFreqMhz, channelNumber, rate, preamble, txVector, aMpdu, signalNoise); }

    static PyObject * _wrap_PcapSniffTxEvent(PyNs3WifiPhyHelper *self, PyObject *args, PyObject *kwargs);
    inline void PcapSniffTxEvent__parent_caller(ns3::Ptr< ns3::PcapFileWrapper > file, ns3::Ptr< ns3::Packet const > packet, uint16_t channelFreqMhz, uint16_t channelNumber, uint32_t rate, ns3::WifiPreamble preamble, ns3::WifiTxVector txVector, ns3::mpduInfo aMpdu)
    { ns3::WifiPhyHelper::PcapSniffTxEvent(file, packet, channelFreqMhz, channelNumber, rate, preamble, txVector, aMpdu); }
...
class PythonCallbackImpl7 : public ns3::CallbackImpl<void, bool, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>
{
public:
    PyObject *m_callback;
    ...
    operator()(bool arg1)
    {
        ...
        __py_gil_state = (PyEval_ThreadsInitialized() ? PyGILState_Ensure() : (PyGILState_STATE) 0);
        args = Py_BuildValue((char *) "(N)", PyBool_FromLong(arg1));
        py_retval = PyObject_CallObject(m_callback, args);
        if (py_retval == NULL) {
            Py_DECREF(args);
            if (PyEval_ThreadsInitialized())
...
class PythonCallbackImpl8 : public ns3::CallbackImpl<void, ns3::Ptr<ns3::Packet>, ns3::WifiMacHeader const*, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>
{
public:
    PyObject *m_callback;
