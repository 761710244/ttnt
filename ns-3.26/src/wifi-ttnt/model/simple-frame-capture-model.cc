...
#include "sinc-simple-frame-capture-model.h"
#include "sinc-wifi-phy.h"
#include "sinc-wifi-utils.h"

namespace ns3 {namespace ttnt {

NS_LOG_COMPONENT_DEFINE ("sinSimpleFrameCaptureModel");
...
{
  static TypeId tid = TypeId ("ns3::sinc-SimpleFrameCaptureModel")
