...
{
  static TypeId tid = TypeId ("ns3::sinc-WifiMac")
    .SetParent<Object> ()
    .SetGroupName ("Wifi")
...
{
	std::cout<<"NotifyTxDrop NotifyTxDrop NotifyTxDrop NotifyTxDrop ***********************************\n";
...
{
	std::cout<<"NotifyRxDrop NotifyRxDrop NotifyRxDrop NotifyRxDrop ***********************************\n";
