...
WifiMode::GetDataRate (uint32_t channelWidth, bool isShortGuardInterval, uint8_t nss) const
{
  ...
  if (item->modClass == WIFI_MOD_CLASS_DSSS)
    {
//      dataRate = 120000/*((11000000 / 11) * numberOfBitsPerSubcarrier)*/; // odie change datarate, While blackHole Test use 1000000 bps
        dataRate = 2000000;
    }
  else if (item->modClass == WIFI_MOD_CLASS_HR_DSSS)
    {
//      dataRate = 120000/*((11000000 / 8) * numberOfBitsPerSubcarrier)*/;
        dataRate = 10000000;
    }
