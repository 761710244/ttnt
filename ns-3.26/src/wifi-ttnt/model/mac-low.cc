 ...
 */
class PhyMacLowListener : public ns3::ttnt::WifiPhyListener
{
public:
  /**
   ...
   * \param macLow
   */
  PhyMacLowListener (ns3::ttnt::MacLow *macLow)
    : m_macLow (macLow)
  {
  }
  ...
  if (m_txParams.MustWaitNormalAck ())
    {
      ...
      //ttnt 120Kbps: 2200 us; Eps 5Mbps: 470 us
      //**********************************************************OD
