 ...
 */
class LowDcfListener : public ns3::ttnt::MacLowDcfListener
{
public:
  /**
   ...
   * \param dcf
   */
  LowDcfListener (ns3::ttnt::DcfManager *dcf)
    : m_dcf (dcf)
  {
  }
...
private:
  ns3::ttnt::DcfManager *m_dcf;  //!< DcfManager to forward events to
};
 ...
 */
class PhyListener : public ns3::ttnt::WifiPhyListener
{
public:
  /**
   ...
   * \param dcf
   */
  PhyListener (ns3::ttnt::DcfManager *dcf)
    : m_dcf (dcf)
  {
  }
  virtual ~PhyListener ()
