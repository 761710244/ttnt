...
#include "ns3/eps-error-rate-model.h"
...
NS_LOG_COMPONENT_DEFINE ("epsYansWifiHelper");
...
YansWifiPhyHelper::YansWifiPhyHelper ()
  : m_channel (0)
{
  m_phy.SetTypeId ("ns3::eps-YansWifiPhy");
}
...
YansWifiPhyHelper::Default (void)
{
  ...
  helper.SetErrorRateModel ("ns3::eps-NistErrorRateModel");
  return helper;
}
