...
#ifndef EPS_WIFI_HELPER_H
#define EPS_WIFI_HELPER_H
...
#include "ns3/eps-wifi-phy-standard.h"
#include "ns3/trace-helper.h"
#include "ns3/eps-wifi-mac-helper.h"
#include "ns3/eps-wifi-phy.h"

namespace ns3 {class Node; namespace elprs {
