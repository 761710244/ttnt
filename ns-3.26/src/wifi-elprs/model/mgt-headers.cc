...
{
  static TypeId tid = TypeId ("ns3::eps-MgtProbeRequestHeader")
    .SetParent<Header> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-MgtProbeResponseHeader")
    .SetParent<Header> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-MgtBeaconHeader")
...
{
  static TypeId tid = TypeId ("ns3::eps-MgtAssocRequestHeader")
    .SetParent<Header> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-MgtAssocResponseHeader")
    .SetParent<Header> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-WifiActionHeader")
    .SetParent<Header> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-MgtAddBaRequestHeader")
    .SetParent<Header> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-MgtAddBaResponseHeader")
    .SetParent<Header> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-MgtDelBaHeader")
    .SetParent<Header> ()
    .SetGroupName ("Wifi")
