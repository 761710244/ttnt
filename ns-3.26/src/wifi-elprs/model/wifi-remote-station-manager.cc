...
NS_LOG_COMPONENT_DEFINE ("epsjWifiRemoteStationManager");
...
{
  static TypeId tid = TypeId ("ns3::eps-HighLatencyDataTxVectorTag")
    .SetParent<Tag> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-HighLatencyRtsTxVectorTag")
    .SetParent<Tag> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-HighLatencyCtsToSelfTxVectorTag")
    .SetParent<Tag> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::eps-WifiRemoteStationManager")
    .SetParent<Object> ()
    .SetGroupName ("Wifi")
