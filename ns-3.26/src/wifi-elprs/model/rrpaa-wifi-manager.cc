...
#include "eps-rrpaa-wifi-manager.h"
#include "eps-wifi-mac.h"
#include "eps-wifi-phy.h"
#include "eps-yans-wifi-phy.h"

NS_LOG_COMPONENT_DEFINE ("epsRrpaaWifiManager");
...
{
  static TypeId tid = TypeId ("ns3::eps-RrpaaWifiManager")
    ...
    .AddTraceSource ("RateChange",
                     ...
                     "ns3::elprs::WifiRemoteStationManager::RateChangeTracedCallback")
    .AddTraceSource ("PowerChange",
                     "The transmission power has change.",
                     MakeTraceSourceAccessor (&RrpaaWifiManager::m_powerChange),
                     "ns3::elprs::WifiRemoteStationManager::PowerChangeTracedCallback")
  ;
  return tid;
}
