...
NS_LOG_COMPONENT_DEFINE ("epsWifiTxCurrentModel");
...
{
  static TypeId tid = TypeId ("ns3::eps-WifiTxCurrentModel")
    .SetParent<Object> ()
    .SetGroupName ("Wifi")
  ;
  return tid;
...
{
  static TypeId tid = TypeId ("ns3::eps-LinearWifiTxCurrentModel")
