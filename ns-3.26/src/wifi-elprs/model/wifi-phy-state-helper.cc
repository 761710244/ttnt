...
NS_LOG_COMPONENT_DEFINE ("epsWifiPhyStateHelper");
...
{
  static TypeId tid = TypeId ("ns3::eps-WifiPhyStateHelper")
    .SetParent<Object> ()
    .SetGroupName ("Wifi")
