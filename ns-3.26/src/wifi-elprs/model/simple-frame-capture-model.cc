...
#include "eps-simple-frame-capture-model.h"
#include "eps-wifi-phy.h"
#include "eps-wifi-utils.h"
...
NS_LOG_COMPONENT_DEFINE ("epsSimpleFrameCaptureModel");
...
{
  static TypeId tid = TypeId ("ns3::eps-SimpleFrameCaptureModel")
