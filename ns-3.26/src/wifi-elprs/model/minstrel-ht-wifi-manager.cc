...
NS_LOG_COMPONENT_DEFINE ("epsMinstrelHtWifiManager");
...
{
  static TypeId tid = TypeId ("ns3::eps-MinstrelHtWifiManager")
    ...
    .AddTraceSource ("RateChange",
                     ...
                     "ns3::elprs::MinstrelHtWifiManager::RateChangeTracedCallback")
  ;
  return tid;
}
