...
NS_LOG_COMPONENT_DEFINE ("sinMinstrelHtWifiManager");
...
{
  static TypeId tid = TypeId ("ns3::sinc-MinstrelHtWifiManager")
    ...
    .AddTraceSource ("RateChange",
                     ...
                     "ns3::sincgars::MinstrelHtWifiManager::RateChangeTracedCallback")
  ;
  return tid;
}
