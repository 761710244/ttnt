...
NS_LOG_COMPONENT_DEFINE ("sinWifiTxCurrentModel");
...
{
  static TypeId tid = TypeId ("ns3::sinc-WifiTxCurrentModel")
    .SetParent<Object> ()
    .SetGroupName ("Wifi")
  ;
  return tid;
...
{
  static TypeId tid = TypeId ("ns3::sinc-LinearWifiTxCurrentModel")
