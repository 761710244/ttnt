...
NS_LOG_COMPONENT_DEFINE ("sinApWifiMac");
...
{
  static TypeId tid = TypeId ("ns3::sinc-ApWifiMac")
...
ApWifiMac::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
	...
	std::cout<<"AP WIFI MAC REV TIME ------ "<<Simulator::Now()<<std::endl;
