...
NS_LOG_COMPONENT_DEFINE ("sinjWifiRemoteStationManager");
...
{
  static TypeId tid = TypeId ("ns3::sinc-HighLatencyDataTxVectorTag")
    .SetParent<Tag> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::sinc-HighLatencyRtsTxVectorTag")
    .SetParent<Tag> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::sinc-HighLatencyCtsToSelfTxVectorTag")
    .SetParent<Tag> ()
    .SetGroupName ("Wifi")
...
{
  static TypeId tid = TypeId ("ns3::sinc-WifiRemoteStationManager")
    .SetParent<Object> ()
    .SetGroupName ("Wifi")
