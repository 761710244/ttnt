...
#ifndef SINC_WIFI_MAC_HEADER_H
#define SINC_WIFI_MAC_HEADER_H
...
enum WifiMacType
{
  ...
  WIFI_MAC_CTL_RTS,
  WIFI_MAC_CTL_CTS,
  WIFI_MAC_CTL_ACK=0x33,//vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  WIFI_MAC_CTL_BACKREQ=4,
...
enum D_Type
{
	...
	D_TYPE_1_UI_CMD = 3,
	D_TYPE_1_URR_CMD = 35,
	D_TYPE_1_URNR_CMD = 11,
	D_TYPE_1_TOPO_UPDATE = 131,
	D_TYPE_1_VERSION_CANTPRO = 195,
	D_TYPE_1_URNRCOMMAND = 11,
	D_TYPE_1_TEST_CR = 227,

	/////////// Type 3 ///////////
	D_TYPE_3_UI_CMD = 19,
	D_TYPE_3_URR_RES = 51,
	D_TYPE_3_URNR_RES = 27,
	D_TYPE_3_TEST_CR = 243
};
/////////////////////////////////////////////////////////
...
public:
 ...
 // void d_SetTransInfo (void);
  void d_SetFEC (void);
  void d_SetTDC (void);
  void d_Setscramble (void);
  void d_SetTversio (void);
  void d_SetTranQue (void);
  void d_SetFCS ();
 uint32_t calculate_CRC32(uint8_t *pStart, uint32_t uSize);
 // void d_Setctl (void);
 // void d_Setinfo (void);
  //void d_SetAddr1 (Mac48Address address);
 // void d_SetAddr2 (Mac48Address address);

 bool d_IsType1 () const;
 void d_SetType (uint8_t typekind);
  ///////////////////////////////////////////////////////////////////////////////////////////
...
private:
  ...
  uint16_t d_GetTransInfo (void) const;
  void d_SetTransInfo (uint16_t ctrl) ;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  uint8_t d_flag=0x7E;	//01111110

  //uint16_t d_TransInfo;
  uint8_t  d_FEC;
  uint8_t d_TDC;
  uint8_t d_scramble;
  uint8_t d_version;
  ...
  uint32_t d_FCS=0xffffffff;
 // uint32_t d_FCS2=0xffffffff;
  uint8_t d_ctl;
  //uint8_t d_info;

 // Mac48Address d_addr1;
  //Mac48Address d_addr2;
