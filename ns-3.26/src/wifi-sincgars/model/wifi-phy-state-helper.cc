...
NS_LOG_COMPONENT_DEFINE ("sinWifiPhyStateHelper");
...
{
  static TypeId tid = TypeId ("ns3::sinc-WifiPhyStateHelper")
    .SetParent<Object> ()
    .SetGroupName ("Wifi")
