...
NS_LOG_COMPONENT_DEFINE ("sinNistErrorRateModel");
...
{
  static TypeId tid = TypeId ("ns3::sinc-NistErrorRateModel")
  ...
  if (mode.GetModulationClass () == WIFI_MOD_CLASS_ERP_OFDM
  ...
  else if (mode.GetModulationClass () == WIFI_MOD_CLASS_DSSS || mode.GetModulationClass () == WIFI_MOD_CLASS_HR_DSSS)
    {
      switch (mode.GetDataRate (20, 0, 1))
        {
      case 120000:
    	  return DsssErrorRateModel::GetDsssDbpsk120KSuccessRate(snr, nbits);
        case 1000000:
