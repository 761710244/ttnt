...
#include <cmath>
#include "sinc-rrpaa-wifi-manager.h"
#include "sinc-wifi-mac.h"
#include "sinc-wifi-phy.h"
#include "sinc-yans-wifi-phy.h"

NS_LOG_COMPONENT_DEFINE ("sinRrpaaWifiManager");
...
{
  static TypeId tid = TypeId ("ns3::sinc-RrpaaWifiManager")
    ...
    .AddTraceSource ("RateChange",
                     ...
                     "ns3::sincgars::WifiRemoteStationManager::RateChangeTracedCallback")
    .AddTraceSource ("PowerChange",
                     "The transmission power has change.",
                     MakeTraceSourceAccessor (&RrpaaWifiManager::m_powerChange),
                     "ns3::sincgars::WifiRemoteStationManager::PowerChangeTracedCallback")
  ;
  return tid;
}
