...
#include "ns3/sinc-error-rate-model.h"
#include "ns3/propagation-loss-model.h"
#include "ns3/propagation-delay-model.h"
#include "ns3/sinc-yans-wifi-channel.h"
#include "ns3/sinc-yans-wifi-phy.h"
...
NS_LOG_COMPONENT_DEFINE ("sinYansWifiHelper");
...
YansWifiPhyHelper::YansWifiPhyHelper ()
  : m_channel (0)
{
  m_phy.SetTypeId ("ns3::sinc-YansWifiPhy");
}
...
YansWifiPhyHelper::Default (void)
{
  ...
  helper.SetErrorRateModel ("ns3::sinc-NistErrorRateModel");
  return helper;
}
