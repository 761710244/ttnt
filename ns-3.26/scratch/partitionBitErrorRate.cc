...
int main(int argc, char *argv[]) {
    ...
    bool linkOpt = false;
    bool verbose = true;
    uint16_t partitionBitErrorRate = 1;
    bool partitionOpti = false;
    ...
    cmd.AddValue("partitionBitErrorRate", "BitErrorRate", partitionBitErrorRate);
    cmd.AddValue("partitionOpti", "if to opti", partitionOpti);
    ...
    UdpServer::partitionInit(1, partitionBitErrorRate, partitionOpti);
