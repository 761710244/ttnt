...
int main(int argc, char *argv[]) {
    ...
    cmd.AddValue("mobilityOpt", "if to optimize", mobilityOpt);
    ...
    UdpServer::MobilityPredict(2, mobilityOpt);
    if(mobilityOpt){
        dsr::DsrOptions::partitionWindow("ReRouting");
    }else{
        dsr::DsrOptions::partitionWindow("Mobility");
    }
